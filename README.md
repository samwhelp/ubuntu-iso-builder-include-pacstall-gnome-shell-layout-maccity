...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/ubuntu-iso-builder-include-pacstall-gnome-shell-layout-maccity/tree/main/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/ubuntu-iso-builder-include-pacstall-gnome-shell-layout-maccity/tree/main/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/ubuntu-iso-builder-include-pacstall-gnome-shell-layout-maccity/tree/main/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [ubuntu-iso-builder-include-pacstall-gnome-shell-layout-maccity](https://github.com/samwhelp/ubuntu-iso-builder-include-pacstall-gnome-shell-layout-maccity)

``` sh
git clone https://github.com/samwhelp/ubuntu-iso-builder-include-pacstall-gnome-shell-layout-maccity.git
```


> change dir to `ubuntu-iso-builder-include-pacstall-gnome-shell-layout-maccity`

``` sh
cd ubuntu-iso-builder-include-pacstall-gnome-shell-layout-maccity
```
...
> The resulting ISO file will be placed on `ubuntu-iso-builder-include-pacstall-gnome-shell-layout-maccity/dist`
